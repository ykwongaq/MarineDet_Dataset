...
def main(json_file:str, output_folder:str, seen_file:str, unseen_file:str):
    ...
    seen_categories_count = count_categories(seen_classes)
    log(f"Seen categories count: {seen_categories_count}")

    unseen_categories_count = count_categories(unseen_classes)
    log(f"Unseen categories count: {unseen_categories_count}")

    seen_annotation_count = count_annotations_based_on_mapping(json_data, seen_classes)
    log(f"Seen annotation count: {seen_annotation_count}")

    unseen_annotation_count = count_annotations_based_on_mapping(json_data, unseen_classes)
    log(f"Unseen annotation count: {unseen_annotation_count}")
